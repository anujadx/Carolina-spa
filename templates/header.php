...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Italianno|Lato:400,700,900|Raleway:400,900" rel="stylesheet">
      ...
      <header class="site-header container">
          <div class="row ">
            <div class="col-8 offset-2 col-lg-4 offset-lg-0">
              <a href="index.php"><img src="img/logo.svg" alt="logo" class="img-fluid mx-auto d-block"></a>
            </div>
